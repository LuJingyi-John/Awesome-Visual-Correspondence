# Must-read papers on Awesome-Visual-Correspondence
## [Content](#content)
...
1. **LIFT: Learned Invariant Feature Transform.** LIFT 2016. [paper](https://arxiv.org/abs/1603.09114)
...
1. **LF-Net: Learning Local Features from Images.** NeurIPS 2018. [paper](https://arxiv.org/abs/1805.09662)
...
1. **Attentive Semantic Alignment with Offset-Aware Correlation Kernels.** ECCV 2018. [paper](https://arxiv.org/abs/1808.02128)
...
1. **R2D2: Repeatable and Reliable Detector and Descriptor.** NeurIPS 2019. [paper](https://arxiv.org/abs/1906.06195)
...
1. **DISK: Learning local features with policy gradient.** NeurIPS 2020. [paper](https://arxiv.org/abs/2006.13566)
...
1. **Probabilistic Model Distillation for Semantic Correspondence.** CVPR 2021. [paper](https://openaccess.thecvf.com/content/CVPR2021/papers/Li_Probabilistic_Model_Distillation_for_Semantic_Correspondence_CVPR_2021_paper.pdf)

    *Xin Li, Deng-Ping Fan, Fan Yang, Ao Luo, Hong Cheng, Zicheng Liu*

1. **Warp Consistency for Unsupervised Learning of Dense Correspondences.** ICCV 2021. [paper](https://arxiv.org/abs/2104.03308)
...
1. **Diffusion Hyperfeatures: Searching Through Time and Space for Semantic Correspondence.** NeurIPS 2023. [paper](https://arxiv.org/abs/2305.14334)
